        ...
        <div className="rounded-[28px] bg-white/[0.04] border border-white/[0.08] backdrop-blur-xl overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="min-w-0">
                    <p className="text-[13px] font-semibold text-white truncate">alex.music</p>
            ...
            {/* Main image area */}
            <div className="relative mx-3 h-[250px] rounded-2xl bg-gradient-to-br from-purple-600/80 to-pink-500/80 overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                    <Music size={44} className="text-white/20"/>
                </div>

                {/* Playing badge */}
                <div className="absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                    <div className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse"/>
                    <span className="text-[10px] font-medium text-white">Playing</span>
                </div>

                {/* Small thumbnail */}
                <div className="absolute top-3 right-3 w-[52px] h-[52px] rounded-lg bg-gradient-to-br from-pink-400/90 to-purple-600/90 border border-white/20 flex items-center justify-center">
            ...
            <div className="mx-3 mt-3 mb-1 flex items-center gap-2.5 p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06]">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-pink-500/80 to-purple-600/80 flex items-center justify-center shrink-0">
                    <Music size={12} className="text-white/80"/>
                </div>
                <div className="min-w-0">
                    <p className="text-[13px] font-semibold text-white truncate">Midnight Drive</p>
                    <p className="text-[11px] text-white/50 truncate">Arctic Synthwave</p>
                </div>
            ...
            <div className="flex items-center gap-4 px-5 py-3">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-xs text-white/70">8</span>
                </div>
            </div>
        </div>
    </div>
