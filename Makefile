...
build_staging:
	...
	@docker build \
    	...
    	--tag "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):staging" \
    	--tag "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):staging-$(VERSION)" \
...
build_production:
	...
	@docker build \
    	...
    	--tag "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):latest" \
    	--tag "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):$(VERSION)" \
...
push_staging: build_staging
	...
	@docker push "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):staging"
	@docker push "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):staging-$(VERSION)"
...
push_production: build_production
	...
	@docker push "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):latest"
	@docker push "$(ECR_REGISTRY)/your-org/$(SERVICE_NAME):$(VERSION)"
